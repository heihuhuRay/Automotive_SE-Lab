 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[0].ID.B.STD_ID = 0x401; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[1].ID.B.STD_ID = 75; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[2].ID.B.STD_ID = 0x403; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[3].ID.B.STD_ID = 0x404; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[4].ID.B.STD_ID = 0x405; /* Change to the correct ID! */
    ...
    /* STD_ID */
    CAN_0.BUF[5].ID.B.STD_ID = 75; /* Change to the correct ID! */
    
     /* Buffer 7 */
    /* MB Code */
    CAN_0.BUF[7].CS.B.CODE = 8;
    /* Standard format */
    CAN_0.BUF[7].CS.B.IDE = 0;
    /* SRR */
    CAN_0.BUF[7].CS.B.SRR = 0;
    /* Data Frame */
    CAN_0.BUF[7].CS.B.RTR = 0;
    /* Data Length */
    CAN_0.BUF[7].CS.B.LENGTH = 2;
    /* STD_ID */
    CAN_0.BUF[7].ID.B.STD_ID = 0x402; /* Change to the correct ID! */
