 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[0].ID.B.STD_ID = 0x201; /* RPM message id */
    ...
    /* STD_ID */
    CAN_0.BUF[1].ID.B.STD_ID = 0x202; /* gear data message id */
    ...
    /* Data Length */
    CAN_0.BUF[2].CS.B.LENGTH = 1;
    /* STD_ID */
    CAN_0.BUF[2].ID.B.STD_ID = 0x203; /* ASR message warning id */
    ...
    /* STD_ID */
    CAN_0.BUF[3].ID.B.STD_ID = 0x204; /* alive signal message id */
    ...
    /* STD_ID */
    CAN_0.BUF[4].ID.B.STD_ID = 0x205; /* error message id */
    ...
    /* STD_ID */
    CAN_0.BUF[5].ID.B.STD_ID = 0x206; /* Change to the correct ID! */
