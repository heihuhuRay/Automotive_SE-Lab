...
void InterruptInit()
{
    ...
    // interrupt priority register CAN ERR
    INTC.PSR[65].B.PRI = 0x1;
    // interrupt priority register CAN BOFF
    INTC.PSR[66].B.PRI = 0x1;
    // interrupt priority register CAN Wakeup
    INTC.PSR[67].B.PRI = 0x1;
    ...
    // eTimer 0 channel 0 interrupt
    INTC.PSR[157].B.PRI = 0x1; 
}
