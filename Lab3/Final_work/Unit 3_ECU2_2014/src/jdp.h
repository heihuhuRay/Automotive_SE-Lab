/***************************************************************** 
 * PROJECT     : MPC560xB, MPC560xP2 & MPC560xS
 *               SPC560xB, SPC560xP2 & SPC560xS 
 * FILE        : jdp.h
 * 
 ...
 * HISTORY     :  Modified to support DSPI0 CS7&8 and new FlexPWM naming on Pictus cut 2 - do not distribute! (r60321)
...
/****************************************************************************/
    ...
    struct DCU_tag {
        ...
        } THRESHOLDINP;         /* Threshold Input Buffer Register */

        vuint32_t DCU_reserved1[0x072]; /* Unused from end of registers */

        vuint32_t CURSOR[0x0100];       /* Hardware Cursor = 256 * 32bit */

        vuint32_t DCU_reserved2[0x200]; /* Unused = 512 * 32bit */

        vuint32_t CLUT[0x0400]; /* CLUT-Pallete memory = 1k * 32bit */

        vuint32_t TILE[0x0400]; /* Tile memory = 1k * 32bit */
